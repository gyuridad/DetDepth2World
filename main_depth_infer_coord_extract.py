...
if __name__=="__main__":
    ...
    assert bgr is not None, f"이미지를 못 읽음 : {input_img_path}"
    H0, W0 = bgr.shape[:2]
    # print(f"H0, W0 => {H0}, {W0}")
    ...
    rgb_pil, _, focal_px = depth_pro.load_rgb(input_img_path)  # focal_px는 픽셀 단위
    ...
    yolo_res = yolo.predict(source=bgr, conf=yolo_conf, verbose=False)
